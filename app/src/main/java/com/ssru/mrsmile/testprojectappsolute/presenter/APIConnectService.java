 ...
 */
public class APIConnectService extends AsyncTask<Void , Void , List<Faculty>> {

    private HttpURLConnection urlConnection;
    private OpenHelperController helperController;

    private static String TAG = "APIConnectService";

    public APIConnectService(Context context) {
    ...
    protected List<Faculty> doInBackground(Void... params) {
        ...
        helperController.deleteData();
        helperController.saveData(faculties);
